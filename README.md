...
Ab Version 0.5.8 sind die fachlichen Extraktionstests von `public/config/label-profiles.json` getrennt. Die im Editor exportierte Profildatei darf daher beliebige eigene Kunden- und Produktprofile enthalten. Der Build prüft nur noch die technische Gültigkeit der produktiven JSON-Datei.
